(function () {
  ...
  SLIDES.forEach(function (s) {
    ...
    s.html =
      '<div class="wrap">' +
        ...
        '<div class="eyebrow" data-r><span class="rn ' + p.cls + '">' + p.rn + '</span><span>Часть · ' + p.yrs + '</span></div>' +
  ...
  var YEARS = PARTS.map(function (p) { return p.key; });
  ...
  function paint() {
    ...
    if (hc) hc.textContent = overview ? 'Карта пути' : (s.kind === 'cover' ? 'Тема 4' : p.rn + ' · ' + p.title);
